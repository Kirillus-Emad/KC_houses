...
def apply_standard_scaler(
    train_path=DF_TRAIN_ENCODED,
    test_path=DF_TEST_ENCODED,
    columns=None,
    save_train_path=DF_TRAIN_ANN_SCALE,
    save_test_path=DF_TEST_ANN_SCALE,
    save_model_path=ANN_SCALER_MODEL
):
    """
...
if __name__ == "__main__":
    ...
    apply_standard_scaler(columns=scale_columns)